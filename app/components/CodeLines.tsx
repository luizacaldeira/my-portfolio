...
return (
      ...
      <div className="flex gap-2 pl-8 animate-shake animate-infinite animate-duration-10000">
            <div className="bg-slate-400/80 w-20 lg:w-30 h-1 rounded-sm animate-fade-left animate-delay-150" />
            <div className="bg-indigo-500 w-46 lg:w-56 h-1 rounded-sm animate-fade-left animate-delay-200" />
      </div>

      {/* linha 2 */}
      <div className="flex gap-2 pl-3 animate-shake animate-infinite animate-duration-10000 animate-delay-500">
            <div className="bg-violet-500 lg:w-12 h-1 rounded-sm animate-fade-left animate-delay-220" />
      ...
      <div className="flex gap-2 pl-12 animate-shake animate-infinite animate-duration-10000 animate-delay-900">
            <div className="bg-pink-600 w-16 lg:w-26 h-1 rounded-sm animate-fade-left animate-delay-320" />
            <div className="bg-indigo-500 w-50 lg:w-60 h-1 rounded-sm animate-fade-left animate-delay-360" />
      </div>

      {/* linha 4 */}
      <div className="flex gap-2 pl-1 animate-shake animate-infinite animate-duration-10000 animate-delay-1300">
            <div className="bg-violet-400 w-10 lg:w-30 h-1 rounded-sm animate-fade-left animate-delay-380" />
            <div className="bg-indigo-300 w-34 lg:w-44 h-1 rounded-sm animate-fade-left animate-delay-420" />
            <div className="bg-indigo-600 w-18 lg:w-28 h-1 rounded-sm animate-fade-left animate-delay-450" />
      </div>

      {/* linha 5 */}
      <div className="flex gap-2 pl-10 animate-shake animate-infinite animate-duration-10000 animate-delay-1800">
            <div className="bg-slate-500 w-27 lg:w-33 h-1 rounded-sm animate-fade-left animate-delay-480" />
      ...
      <div className="flex gap-2 pl-5 animate-shake animate-infinite animate-duration-10000 animate-delay-2300">
            ...
            <div className="bg-indigo-600 w-50 lg:w-64 h-1 rounded-sm animate-fade-left animate-delay-580" />
      </div>
      </div>
);
}